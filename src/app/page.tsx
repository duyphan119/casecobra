    ...
    <div className="bg-slate-50">
          ...
          <div className="mx-auto max-w-2xl grid grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              <div className="flex gap-0.5 mb-2">
                <Star className="h-5 w-5 tet-green-600 fill-green-600" />
                <Star className="h-5 w-5 tet-green-600 fill-green-600" />
                <Star className="h-5 w-5 tet-green-600 fill-green-600" />
                <Star className="h-5 w-5 tet-green-600 fill-green-600" />
                <Star className="h-5 w-5 tet-green-600 fill-green-600" />
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  and led to some pretty heavy scratchmarks on all of my last
      ...
      <section className="">
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              <div className="relative h-80 md:h-full w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                <img
                  src="/horse.jpg"
                  className="rounded-md obejct-cover bg-white shadow-2xl ring-1 ring-gray-900/10 h-full w-full"
                />
              </div>
          ...
          <div className="mx-auto max-w-prose sm:text-lg mt-2 w-fit flex justify-center">
            <Link
